<?php
    ...
    if(!empty($_POST['nama']) AND !empty($_POST['keperluan'])) {
        ...
        $fp = fopen("db.html", 'a');
        fwrite($fp, "<div class='list$l'><div class='hr'><div align='right'>$tgl</div></div> <b>Nama</b> : $nama <br> <b>noHP</b> : $nohp <br> <b>Alamat</b> : $alamat <br> <b>Kota/Kabupaten</b> : $kota <br> <b>Keperluan</b> : $text </div>");
        fclose($fp);
    }
